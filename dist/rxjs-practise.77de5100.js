...
},{"tslib":"node_modules/tslib/tslib.es6.js","./isFunction":"node_modules/rxjs/dist/esm5/internal/util/isFunction.js"}],"C:/Users/2311005/AppData/Roaming/nvm/v18.16.1/node_modules/parcel-bundler/node_modules/process/browser.js":[function(require,module,exports) {
...
// 按鈕 DOM
var startCountorBtn = document.getElementById('startCountorBtn');
...
var counter$;
// 訂閱：「開始新的計數器」按鈕事件
(0, rxjs_1.fromEvent)(startCountorBtn, 'click').subscribe(function () {
  // 初始化
  ...
  var counterObserver = {
    next: function next(data) {
      currentCount.innerText = "".concat(data);
    },
    error: function error(message) {
      status.innerText = "".concat(message);
    },
  ...
  evenCounter$.subscribe(function (data) {
    evenCount.innerText = "".concat(data);
  });
  // 送出預設值，讓畫面一開始為 0
  counter$.next(count);
});
...
(0, rxjs_1.fromEvent)(counterBtn, 'click').subscribe(function (data) {
  counter$.next(++count);
});
// 步驟 4：實作「發生錯誤」及「完成計數」按鈕
(0, rxjs_1.fromEvent)(errorBtn, 'click').subscribe(function (data) {
  var message = prompt('請輸入錯誤訊息');
  counter$.error(message || 'error');
});
(0, rxjs_1.fromEvent)(completedBtn, 'click').subscribe(function () {
  counter$.complete();
});
},{"rxjs":"node_modules/rxjs/dist/esm5/index.js","rxjs/operators":"node_modules/rxjs/dist/esm5/operators/index.js"}],"C:/Users/2311005/AppData/Roaming/nvm/v18.16.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/2311005/AppData/Roaming/nvm/v18.16.1/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.ts"], null)
//# sourceMappingURL=/rxjs-practise.77de5100.js.map